<template>
    ...
    <div style="background: #2e2e36;" class="container pb-4 mb-5">
        ...
        <div class="ps-5 pb-3 mb-3">
            <p class="fs-5 d-inline fw-bold" style="color: rgba(255, 255, 255, 0.950);">Prędkość:</p> <p class="d-inline fs-5 ms-3" style="color: rgba(255, 255, 255, 0.850);">{{ item.raceSpeed }}</p>
        </div>
        <div class="ps-5 pb-3 mb-3">
...
export default {
    ...
    created() {
        axios.get('https://kumpleismokibbkservice.azurewebsites.net/api/Race/checkifupvote/' + this.id, {
                headers: {
    ...
    methods: {
        deleted() {
            ...
            axios.delete('https://kumpleismokibbkservice.azurewebsites.net/api/Race', {
                ...
                setTimeout(() => {
                    this.$router.push('/StworzoneRasy')
                }, 1000))
        ...
        upVote() {
            axios.get('https://kumpleismokibbkservice.azurewebsites.net/api/Race/upvote/' +  this.id, {
                headers: {
                                Authorization: 'Bearer ' + localStorage.getItem('token')
                            }
            })
